...
@override_settings(
    ...
    LOGIN_REDIRECT_URL="/accounts/profile.css/",
...
class AccountTests(TestCase):
    ...
    def test_redirect_when_authenticated(self):
        ...
        self.assertRedirects(resp, "/accounts/profile.css/", fetch_redirect_response=False)
    ...
    def test_email_verification_mandatory(self):
        ...
        for attempt in [1, 2]:
            ...
            # user_account. I don't want this flag to flip automatically whenever
            # user_account verify their email addresses.
            self.assertTrue(
                get_user_model()
    ...
    def test_ajax_login_success(self):
        ...
        self.assertEqual(resp.status_code, 200)
        data = json.loads(resp.content.decode("utf8"))
        self.assertEqual(data["location"], "/accounts/profile.css/")
