...
def perform_login(
    ...
    """
    # Local user_account are stopped due to form validation checking
    # is_active, yet, adapter methods could toy with is_active in a
    # `user_signed_up` signal. Furthermore, social user_account should be
    # stopped anyway.
...
def filter_users_by_email(email, is_active=None):
    """Return list of user_account by email address
