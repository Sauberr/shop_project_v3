...
Previously, custom_accounts would import :func:`get_style_guide` from ``.flake8.engine``.
...
class Report:
    ...
    .. warning::
        ...
        This should not be instantiated by custom_accounts.
    ...
    def __init__(self, application: app.Application) -> None:
        ...
        .. warning:: This should not be instantiated by custom_accounts.
        """
...
class StyleGuide:
    ...
    .. warning::
        ...
        This object should not be instantiated directly by custom_accounts.
