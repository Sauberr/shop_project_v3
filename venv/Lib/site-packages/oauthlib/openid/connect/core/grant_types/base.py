    ...
    def openid_authorization_validator(self, request):
        ...
        prompt
                ...
                values are:
                    ...
                    End-User to select a user custom_accounts. This enables an End-User
                    who has multiple custom_accounts at the Authorization Server to
                    select amongst the multiple custom_accounts that they might have
                    current sessions for. If it cannot obtain an custom_accounts
