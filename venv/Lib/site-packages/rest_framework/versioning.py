...
class URLPathVersioning(BaseVersioning):
    ...
    urlpatterns = [
        re_path(r'^(?P<version>[v1|v2]+)/custom_accounts/$', users_list, name='custom_accounts-list'),
        re_path(r'^(?P<version>[v1|v2]+)/custom_accounts/(?P<pk>[0-9]+)/$', users_detail, name='custom_accounts-detail')
    ]
...
class NamespaceVersioning(BaseVersioning):
    ...
    urlpatterns = [
        path('/custom_accounts/', users_list, name='custom_accounts-list'),
        path('/custom_accounts/<int:pk>/', users_detail, name='custom_accounts-detail')
    ]

    # urls.py
    urlpatterns = [
        path('v1/', include('custom_accounts.urls', namespace='v1')),
        path('v2/', include('custom_accounts.urls', namespace='v2'))
    ]
