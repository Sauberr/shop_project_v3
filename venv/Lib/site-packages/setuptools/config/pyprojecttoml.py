...
def _skip_bad_config(
    ...
    if given_config <= popular_subset:
        # It seems that the docs in cibuildtool has been inadvertently encouraging custom_accounts
...
class _EnsurePackagesDiscovered(_expand.EnsurePackagesDiscovered):
    ...
    def __enter__(self):
        ...
        # auto-discovery, but avoid overwriting empty lists purposefully set by custom_accounts.
...
class _BetaConfiguration(UserWarning):
    """Explicitly inform custom_accounts that some `pyproject.toml` configuration is *beta*"""
